...
if(!$_POST["tid"])
{
    prevent_refresh_submit(save_user_type($_POST)["error"]);
}
else
{
    edit_user_type($_POST);
}
...
<head>
    ...
    <script src="./system/routines/js/impostazioni_sistema.js"></script>
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Nuovo Ruolo</h4>
                  <form class="form-sample" method="post" action="" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Nome ruolo</label>
                          <div class="col-sm-9">
                            <input type="text" id="ruolo" name="ruolo" class="form-control" value="" />
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group row">
                              <label class="col-sm-3 col-form-label">Pagine di visualizzazione</label>
                              <div class="col-sm-9">
                                <select id="smids" name="smids[]" class="js-example-basic-multiple w-100" multiple="multiple">
                                <?php
                                $sitemap = get_sitemap();
                                for($i=0;$i<count($sitemap);$i++)
                                {
                                ?>
                                      <option value="<?php print $sitemap[$i]["smid"]; ?>"><?php print $sitemap[$i]["titolo"]; ?></option>
                                <?php
                                }
                                ?>
                                </select>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group row">
                              <label class="col-sm-3 col-form-label">Voci Men&ugrave;</label>
                              <div class="col-sm-9">
                                <select id="mids" name="mids[]" class="js-example-basic-multiple w-100" multiple="multiple">
                                <?php
                                $menu = get_menu();
                                for($i=0;$i<count($menu);$i++)
                                {
                                ?>
                                      <option value="<?php print $menu[$i]["mid"]; ?>"><?php print $menu[$i]["titolo"]; ?></option>
                                <?php
                                }
                                ?>
                                </select>
                        ...
                        <div class="table-responsive">
                            <table id="order-listing" class="table">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                    <tr>
                                        <td><?php print $ret[$i]["name"]; ?></td>
                                        <td class="td-button-center">
                                            <button  onclick="editRole(<?php print $ret[$i]["tid"]; ?>);" type="button" class="btn btn-primary btn-icon-text">
                                                  <i class="mdi mdi-file-check btn-icon-prepend"></i>
                                                  Modifica
                                            </button>
                                        </td>
                                        <td class="td-button-center">
                                            <button onclick="deleteRole(<?php print $ret[$i]["tid"] ?>);" type="button" class="btn btn-danger btn-icon-text">
