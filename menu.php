...
if(!$_POST["mid"])
{
    prevent_refresh_submit(save_menu($_POST)["error"]);
}
else
{
    edit_menu($_POST);
...
<head>
    ...
    <script src="./system/routines/js/menu.js"></script>
</head>
<body>
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div id="menu-container" class="row">
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Nuova voce Men&ugrave;</h4>
                  <form class="form-sample" method="post" action="" enctype="multipart/form-data">
                    <p class="card-description">
                      Aggiungi una nuova voce del men&ugrave;
                    </p>
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                              <label class="col-sm-3 col-form-label">Icona Mdi</label>
                              <div class="col-sm-9">
                                <input type="text" id="mdi" name="mdi" class="form-control" value="" />
                              </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group row">
                              <label class="col-sm-3 col-form-label">Priorit&agrave;</label>
                              <div class="col-sm-9">
                                <input type="text" id="prio" name="prio" class="form-control" value="" />
                              </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
          <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <p class="card-title">Men&ugrave;</p>
                <div class="table-responsive">
                  <table id="order-listing" class="table table-hover">
                    ...
                    <tbody>
                        ...
                        ?>
                        <tr>
                            <td><?php print $menu[$i]["prio"]; ?></td>
                            <td><?php print $menu[$i]["titolo"]; ?></td>
                            <td><?php print $menu[$i]["path"]; ?></td>
                            <td><?php print $menu[$i]["mdi"]; ?></td>
                            <td class="td-button-center">
                                <button onclick="gotoLink('#menu-container');editMenu(<?php print $menu[$i]["mid"]; ?>);" type="button" class="btn btn-primary btn-icon-text">
                                    <i class="mdi mdi-file-check btn-icon-prepend"></i>
                                    Modifica
                                </button>
                            </td>
                            <td class="td-button-center">
                                <button onclick="deleteMenu(<?php print $menu[$i]["mid"] ?>);" type="button" class="btn btn-danger btn-icon-text">
